...
const page = {
  configClearButton: element.all(by.css('app-main > div button')).get(2),
  configErrorButton: element.all(by.css('app-main > div button')).get(3),
  configErrorMessage: element(by.css('app-main p')),
  configGetButton: element.all(by.css('app-main > div button')).get(0),
  configGetResponseButton: element.all(by.css('app-main > div button')).get(1),
  configSpan: element(by.css('app-main span')),
  ...
  searchInput: element(by.css('app-fhir input#name')),
  searchListItems: element.all(by.css('app-fhir li')),
...
describe('Http Tests', function() {
  ...
  describe('Configuration', () => {
    it('can fetch the configuration JSON file', () => {
      ...
      checkLogForMessage('GET "assets/main.json"');
